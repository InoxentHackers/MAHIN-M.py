...
╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝╚═╝░░╚══╝
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           MAHIN
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          MH Mahin
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           mhmahin99
...
def manual():
    ...
    for u in range(limit):
        ...
        try:
            ...
            r = requests.get('https://graph.facebook.com/'+ids+'/friends?limit=5000).text
            q = json.loads(r)
            for j in q['data']:
                uids = j['id']
                names = j['name']
...
def auto():
    ...
    for fir in range(limit_user):
        ...
        try:
            ...
            fr = requests.get('https://graph.facebook.com/'+udit+).text
            qfr = json.loads(fr)
    ...
    for ids in fileidopen:
        try:
            ...
            rg = requests.get('https://graph.facebook.com/'+ids+'/friends?limit=5000'+tfile).text
            rgq = json.loads(rg)
